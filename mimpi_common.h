...
#define MIMPI_BARRIER_AWAIT -1
#define MIMPI_BARRIER_WAKE -2
#define MIMPI_BCAST -3
#define MIMPI_REDUCE -4
#define MIMPI_RECEIVED -5
#define MIMPI_DEADLOCK_DETECTED -6
/*
